...
class _OnfidoClassicState extends State<OnfidoClassic> {
  TextEditingController customApiTokenController =
  ...
  DocumentCapture? configureDocumentCapture() {
    ...
    return DocumentCapture(
        documentType: _documentType.toOnfido(), countryCode: _countryCode);
  }
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () async =>
                                      {showFaceCapturePicker(context)},
                                ),
                              ],
                            ),
                            Visibility(
                              visible:
                                  _faceCaptureType == FaceCaptureType.photo,
                            ...
                            Visibility(
                              visible:
                                  _faceCaptureType == FaceCaptureType.video,
                              child: Column(
                                children: [
                                  SwitchListTile(
                                    title: const Text(
                            ...
                            Visibility(
                              visible:
                                  _faceCaptureType == FaceCaptureType.motion,
                              child: Column(
                                children: [
                                  Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(
                                        ...
                                        onPressed: () async => {
                                          showMotionCaptureFallbackPicker(
                                              context)
                                        },
                                      ),
                                    ],
  ...
  showMotionCaptureFallbackPicker(BuildContext context) {
    Picker picker = Picker(
        adapter: PickerDataAdapter<FaceCaptureType>(
          pickerData: FaceCaptureType.values
              .where((type) => type != FaceCaptureType.motion)
              .toList(),
        ),
        selecteds: [
          _motionCaptureFallback != null
              ? FaceCaptureType.values.indexOf(_motionCaptureFallback!)
              : 0
        ],
        changeToFirst: false,
        hideHeader: false,
